...
public class ABC_OSSP {
    ...
    void BeamSearch() {
        OSSP ossp = new OSSP(GlobalParams, noj,  nom, jpT, jmS);
        BEAM_SEARCH_OSSP bossp = new BEAM_SEARCH_OSSP(GlobalParams, noj, nom, D, jpT, jmS, ossp.startT, ossp.endT);
    ...
    int CalculateFunction(int sol[]) {
        ...
        OSSP ossp = new OSSP(sol,noj,nom,jpT,jmS);
        return ossp.minMakespanT;
            //return 1;
    }
}